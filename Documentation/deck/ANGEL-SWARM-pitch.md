...
| | Step | Claim | Detail |
|---|---|---|---|
| **01** | SENSE | The monitor already on him | Compensatory reserve off a wearable, carried forward on Cursor on Target — the feed TAK and ATAK already move. No reachback required. |
...
| **125 devices** | live telemetry, 62 msg/s, none dropped |
